...
import { getDocumentsInSituByEmpresa } from '@shared/api/mock/anexo1Data';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Documentos Realizados */}
        <Card className="p-6 hover:border-success transition-colors">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
        ...
        {/* Evaluaciones */}
        <Card className="p-6 hover:border-warning transition-colors">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
          ...
          <div className="space-y-3">
            {capacitacionesEmpresa.map(cap => (
              ...
              >
                ...
                <Badge variant={cap.estado === 'En curso' ? 'green' : 'blue'}>
                  {cap.estado}
                </Badge>
              </div>
            ))}
