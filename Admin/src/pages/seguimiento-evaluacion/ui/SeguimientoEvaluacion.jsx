  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            {evaluacion.estado === 'Activa' && (
              <>
                ...
                <Button
                  ...
                  variant="primary"
                  className="bg-orange-100 hover:bg-orange-200 text-orange-700 flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {evaluacion.estado === 'Finalizada' && (
              <Badge variant="gray" className="px-4 py-2 font-semibold flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-6 shadow-md border-l-4 border-purple-500">
                ...
                respuestasFiltradas.map(respuesta => {
                  ...
                  return (
                    <tr key={respuesta.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <Badge variant={respuesta.estado === 'Respondida' ? 'green' : 'yellow'}>
                          {respuesta.estado}
                        </Badge>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        {respuesta.estado === 'Respondida' && (
                          <Button
                            ...
                            className="text-primary hover:text-primary-dark px-2 py-1 text-sm font-medium"
                          >
                            Ver Detalle
                          </Button>
                        )}
