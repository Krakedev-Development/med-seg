...
const GestionAnexo1 = ({ companies = initialCompanies }) => {
  ...
  const getCumplimientoBadgeVariant = (porcentaje) => {
    ...
    <div className="space-y-6">
      ...
      <Card className="p-4">
        <div className="relative">
          <SearchIcon className="absolute left-3 top-2.5 w-5 h-5 text-gray-400 z-10" />
          <Input
            type="text"
            value={busqueda}
              ...
              {empresasFiltradas.map((empresa) => (
                <tr key={empresa.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-center">
                    <Badge variant={getCumplimientoBadgeVariant(empresa.porcentajeCumplimiento)}>
