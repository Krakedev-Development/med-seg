...
import { getDocumentosByEmpresaYDiscriminador, crearDocumentoDinamico } from '@entities/document/model/documentsMock';
import { medDocsTemplates as templatesMedicos } from '@shared/api/mock/medDocsTemplates';
...
const EmpresaMediDocs = ({ companies = initialCompanies }) => {
  ...
  const renderDocumento = () => {
    ...
    if (tipo === 'archivo') {
      ...
      if (ext === 'pdf') {
        return (
          <Card className="p-0 border-gray-200 overflow-hidden" style={{ minHeight: '80vh' }}>
            <iframe
          ...
          <div className="flex items-center justify-between">
            <div>
              <Button
                ...
                variant="ghost"
                className="flex items-center gap-2 text-gray-600 hover:text-gray-800 mb-4 transition-colors font-medium p-0"
              >
        ...
        <Card className="p-6 shadow-md">
          <div className="flex gap-3 justify-end">
            ...
            <Button
              ...
              variant="outline"
              className="px-6 py-2 bg-gray-600 text-white border-transparent hover:bg-gray-700 hover:text-white"
            >
              Imprimir
            </Button>
            {esFichaMedica && (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <Card className="p-6 shadow-sm border border-gray-150 rounded-2xl">
        ...
        {templatesFiltrados.length === 0 ? (
          <Card className="border border-dashed border-gray-300 p-12 text-center rounded-2xl">
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={() => window.print()}
                    variant="outline"
                    className="px-4 py-2 bg-gray-600 text-white border-transparent hover:bg-gray-700 hover:text-white"
                  >
                    Imprimir
                  </Button>
                </div>
