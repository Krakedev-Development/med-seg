...
import { getDocumentosByEmpresa, crearDocumentoDinamico, documentosDinamicos } from '@entities/document/model/documentsMock';
import { documentoTemplates } from '@shared/api/mock/documentoTemplates';
import { medDocsTemplatesIndividuales } from '@shared/api/mock/medDocsTemplates';
...
17234567,Diana Carolina,Espín Pazmiño,Asistente de Oficina,F,27,HC-2026-06-01-003,ARCH-2026-06-01-003,2026-01-15,,5`;
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="sticky top-0 z-30 py-3 rounded-lg shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-4">
          <div className="flex flex-1 flex-wrap items-center gap-3">
            ...
            <Button
              ...
              variant="primary"
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold transition-all transform hover:scale-[1.02]"
            >
